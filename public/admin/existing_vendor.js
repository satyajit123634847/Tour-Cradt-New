...

                {
                    ...
                    'render': function (data, type, row) {
                        ...
                        if (level_status == 4) {
                            ...
                            it_csv = `<a href="vendor/download_pdf_it_csv/${data}"><i class="mdi mdi-file-document-box mx-2" title="Download CSV"  style="font-size:24px;color:#0500ff;cursor: pointer;" ></i></a>`
                        } else {
                            it_csv = ""
                        }

                        var downloaded_btn = `<a  onclick="vendor.download_pdf(this)" ><i class="mdi mdi-arrow-down mx-2" title="Download"  style="font-size:24px;color:#0500ff;cursor: pointer;" ></i></a>`
                        ...
                        if (is_download_pdf && level_status != 4) {
                            ...
                            if (downloadAttachment == "" || downloadAttachment == undefined) {
                                ...
                                downloaded_btn = `<a href="${vendor.base_url}/files/${downloadAttachment}" download><i class="mdi mdi-arrow-down mx-2" title="Download"  style="font-size:24px;color:#0500ff;cursor: pointer;" ></i></a>`
                            }
                        ...
                        var is_ban_section = ``
                        if (is_download_pdf && level_status == 4) {
                            is_ban_section = `<i class="mdi mdi-arrow-down-bold mx-2" title="Final File" onclick="vendor.downloaded_final_file(this)"   style="font-size:24px;color:#0500ff; cursor: pointer;"></i>`

                        }
                        return ` <i class="mdi mdi-eye mx-2" title="View" onclick="vendor.view_vendor(this)"   style="font-size:24px;color:#0500ff; cursor: pointer;"></i>  <i class="mdi mdi-timer mx-2" title="Timeline"  style="font-size:24px;color:#0500ff;cursor: pointer;" onclick="vendor.view_time_line(this)"></i>${downloaded_btn} ${it_csv} ${is_ban_section}`
...

                {
                    ...
                    'render': function (data, type, row) {
                        ...
                        if (data == "" || data == null || data == undefined) {
                            return '<i class="mdi mdi-account-check mx-2"  onclick="vendor.forward(this)" title="Forward"   style="font-size:24px;color:#0500ff; cursor: pointer;"></i>  <i class="mdi mdi-account-remove mx-2 it_team_remove"   style="font-size:24px;color:red;cursor:pointer" onclick="vendor.revert(this)" title="Revert"></i>'
                        } else {
                            if (data._id == sessionStorage.getItem("user_id")) {
                                ...
                                if (sessionStorage.getItem("user_status") == "IT Team") {
                                    ...
                                    if (is_download_pdf) {
                                        return ' <i class="mdi mdi-account-check mx-2"  onclick="vendor.forward(this)" title="Forward"   style="font-size:24px;color:#0500ff; cursor: pointer;"></i> '
                                    } else {
                                        return '<i class="mdi mdi-checkbox-multiple-marked-circle mx-2"  onclick="vendor.ban_create(this)" title="Forward"   style="font-size:24px;color:#0500ff; cursor: pointer;"></i> '
            ...
            if (data.status) {
                ...
                if (info.gst_url.length > 0) {
                    ...
                    info.gst_url.map(info => {
                        ...
                        </div><a href="${vendor.base_url}/files/${info}" download><i class="mdi mdi-arrow-down mx-2" title="Download"  style="font-size:24px;color:#0500ff;cursor: pointer;" ></i></a>`
                        } else if (ex == "pdf") {
