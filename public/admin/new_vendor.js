        ...
        $('#vendor_table').DataTable({
            ...
            "buttons": [
                ...
                },
                {
                    ...
                    'class': 'center',
                    'render': function (data, type, row) {
                        return ' <i class="mdi mdi-eye mx-2" title="View" onclick="vendor.view_vendor(this)"   style="font-size:24px;color:#0500ff; cursor: pointer; display:none;"></i>  <i class="mdi mdi-timer mx-2" title="Timeline"  style="font-size:24px;color:#0500ff;cursor: pointer;" onclick="vendor.view_time_line(this)"></i>'
                    }
                },
                {
                    'data': 'link_status',
