var assistance = {
  ...
  list_assistance: function (e) {
    $("#add_assistance_table").DataTable({
      ajax: {
        url: this.base_url + "/admin/list_destination_admin",
        type: "GET",
        datatype: "json",
      },
      buttons: [
  ...
  add_assistance: function (e) {
    ...
    if (id == null || id == "") {
      var $request = $.ajax({
        url: `${assistance.base_url}/admin/add_destination`,
        type: "POST",
        dataType: "json",
      ...
      $request.done(function (data) {
        if (data.status) {
          ...
          setTimeout(() => {
            window.location = "/add-destination";
          }, 1000);
        } else {
      ...
      var $request = $.ajax({
        url: `${assistance.base_url}/admin/update_destination/${id}`,
        type: "PUT",
        dataType: "json",
        contentType: "application/json",
        data: JSON.stringify(obj),
  ...
  delete_assistance: function (e) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        var $request = $.ajax({
          url: `${assistance.base_url}/admin/delete_destination/${id}`,
          type: "PUT",
          dataType: "json",
          contentType: "application/json",
        });
